...
public class UniverseServiceImpl implements UniverseService {
    ...
    public List<Integer> getAllTypeID() {
        ...
        while (true) {
            ...
            types.addAll(JSONArray.parseArray(jsonSting).toJavaList(Integer.class));
            pageNum++;
        }
        return types;
    }
    ...
    public void updateTypes() {
        ...
        UniverseServiceImpl universeServiceImplProxy = SpringUtils.getBean(UniverseServiceImpl.class);
    ...
    public void updateRegions() {
        ...
        String jsonStr;
        List<Integer> lt = MyRT.restTemplate.getForObject(regionsUrl, List.class, params);
        for (int regionID : lt) {
            jsonStr = MyRT.getReq(regionsDetailUrl + regionID + queryParams, params);
    ...
    public void updateConstellations() {
        ...
        String jsonStr;
        Constellations tar;
        List<Integer> lt = MyRT.restTemplate.getForObject(constellatonsUrl, List.class, params);
        for (int id : lt) {
            jsonStr = MyRT.getReq(constellatonsDetailUrl + id + queryParams, params);
    ...
    public void updateSystems() {
        ...
        HttpStatus status;
        Systems tar;
        List<Integer> lt = MyRT.restTemplate.getForObject(systemsUrl, List.class, params);
        for (int id : lt) {
            responseEntity = MyRT.restTemplate.getForEntity(systemsDetailUrl + id + queryParams, String.class, params);
